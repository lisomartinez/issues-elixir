defmodule Issues.TableFormatter do
  ...
  That is, each header identifies a columns, and those columns are extracted and printed
  from the rows. We calculate the width of each column to fit the longest element
  in that
  """
  ...
  each column. The `headers` parameter contains the list of columns to extract
  ...
  @doc """
  Given a list containing sublists, where each sublist contains the data for a column, return a lista containing the maximum width of each column.
  ...
  of hyphens, with + signs where the vertical bar between the column goes
